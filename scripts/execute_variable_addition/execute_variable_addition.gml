//  @function				execute_variable_addition()
/// @argument				{string} name
/// @argument				{InterpretedVariable|InterpretedFunctionCall|any} value
/// @description			Execute a variable addition to a variable of the specified name in the
...
function execute_variable_addition(_name, _value)
{
	...
	var _adding_value = ((instanceof(_value) == "InterpretedFunctionCall")
						 ? execute_function_call(_value.function_index, _value.function_argument)
						 : get_interpreted_value(_value));
	
	variable_struct_set(_scope, _name, (_current_value + _adding_value));
}
